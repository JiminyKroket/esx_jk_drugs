Locales ['en'] = {
  -- police
  ['bca_pass'] = 'Tested negative with less than 0.01%',
  ['drug_pass'] = 'Tested negative for narcotic use',
  ['drug_fail'] = 'Tested positive for narcotic use',
  ['fail_drunk'] = 'Tested positive with .16%',

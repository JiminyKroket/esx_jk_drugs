Locales ['en'] = {
  ...
  ['dealer_bye'] = 'You and the dealer never saw each other.',
  ...
  -- blips
  ['blip_weedfield'] = 'Stank Field',
  ['blip_cocainefield'] = 'Cotton Field',
  ['blip_ephedrinefield'] = 'Restricted Area',
  ['blip_drugdealer'] = 'Smoke on the Water',
  ['blip_poppyfield'] = 'Apple Orchard',
}
